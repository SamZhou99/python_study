...
def read_file():
    f = open("./gno_mysql_data_2.sql", "r", encoding="utf-8")
    return f.read()


def sql_execute(t):
    # t = """CREATE TABLE IF NOT EXISTS user_list(
    ...
    #   id INTEGER PRIMARY KEY AUTOINCREMENT,
    #   account TEXT(255)  DEFAULT '' ,
    #   password TEXT(255)  DEFAULT '' ,
    #   verify_code TEXT(255) DEFAULT '' ,
    #   notes TEXT(255) DEFAULT '' ,
    #   type INTEGER(3)  DEFAULT '0' ,
